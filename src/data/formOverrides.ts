...
export const formOverrides: Record<string, { score: number; note: string }> = {
  ...
  "ENG": { score: 68, note: "R32: 2-1 COD. Kane brace (Gordon assists, 75' + 86'). Trailed 0-1 from 7' to 75' — comeback from first WC deficit since 1966 final. RB crisis (Spence) exposed, Bellingham subdued. Altitude challenge vs MEX at Azteca next. Stage boost applied." },
