...
export const formOverrides: Record<string, { score: number; note: string }> = {
  ...
  "CRO": { score: 55, note: "MD2: 1-0 PAN. Needed Budimir sub (54') to unlock game. Livakovic MOM. Attack still muted. 4pts Group L. MD3: 2-1 GHA — won comfortably but conceded late; Ghana scored once. Croatia advance 2nd in Group L." },
