...
export const formOverrides: Record<string, { score: number; note: string }> = {
  ...
  "ALG": { score: 82, note: "MD3: 3-3 AUT thriller. Mahrez decisive. Attack significantly elevated. Amoura out (hamstring). Genuine R32 threat vs Switzerland." },
  "SUI": { score: 72, note: "Solid group stage: 2W-1D-0L, 7 goals scored, 3 conceded. MD3: 2-1 CAN — topped Group B. Attack stronger than 1-1 suggested." },
};
