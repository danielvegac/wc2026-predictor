...
export const formOverrides: Record<string, { score: number; note: string }> = {
  ...
  "USA": { score: 79, note: "R16 vs BEL. Best USMNT group stage ever: 8 goals, 6pts, 1st in Group D. R32: 2-0 BIH with 10 men (Balogun red, Tillman free kick). Pochettino system clicking. Balogun suspension lifted." },
  "BRA": { score: 72, note: "R32: 2-1 JPN. Vini Jr brace — clinical finishing on 2.4 xG. Cunha–ViniJr combination confirmed. Paquetá availability unclear. Japan pressed but lacked individual quality to threaten. Stage boost applied." },
  "POR": { score: 88, note: "R32: 2-1 CRO thriller. Ronaldo pen 68', Ramos 90+4. Dominated xG (2.18 vs 1.34). Ronaldo aging but still decisive. Ramos super-sub weapon. Advancing vs ESP — massive test. Attack confirmed quality." },
  ...
  "ENG": { score: 74, note: "R16 active vs MEX (Azteca). Won group (4-2 CRO, 2-0 PAN). R32: 2-1 COD trailing 75min — Kane brace saved them. xG solid but converting poorly. Structural defensive concerns." },
