...
export const formOverrides: Record<string, { score: number; note: string }> = {
  ...
  "CRO": { score: 52, note: "Croatia 1-0 Panama (MD2). Needed sub to unlock — Budimir 54'. Struggled badly vs 5-4-1 block first 45 min. Attack still muted but Livakovic heroic. Croatia form: improved from 38 after England loss but still below baseline. Must beat Ghana in MD3 to advance." },
  "PAN": { score: 28, note: "Panama 0-1 Croatia (MD2, eliminated). Eliminated from WC. Competitive defensively — held Croatia scoreless until 54'. But 0 goals in 2 WC matches, no clinical edge. Panama defense shown resilience but attack is bottom tier." },
  "COL": { score: 78, note: "Colombia 1-0 DR Congo (MD2, qualified). 6pts, top Group K. Muñoz 76' winner. 20 shots / 1.03 xG — dominant but frustrated by elite GK. Díaz continues to be the key attacking threat (5 shots). James 5 chances created. Attack quality intact but finishing efficiency dipped. Clean sheet — defense solid again." },
  "COD": { score: 61, note: "DR Congo 0-1 Colombia (MD2). Held Colombia scoreless until 76' despite facing 20 shots. Mpasi (GK) was standout — 8 saves. 5-3-2 defensive block working: only 2 goals conceded in 2 matches. Offensive output minimal — 0.39 xG, 8 shots, 1 on target. Survival depends on beating Uzbekistan in MD3." },
  "ENG": { score: 68, note: "England 0-0 Ghana (MD2). Disappointing stalemate — neither team recorded a shot on target in first half. England failed to break down organized Ghana. Down from 82 after England MD1 dominance. Still top Group L on 4pts but performance regressed sharply from Croatia game." },
  "GHA": { score: 55, note: "Ghana 0-0 England (MD2). Excellent defensive display — held England scoreless. With Partey starting, midfield improved significantly. Ghana now 3pts in Group L, still in contention for R32. More organized than Panama game suggested." },
};
