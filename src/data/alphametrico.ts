...
export const alphaMatchData: AlphaMatchData[] = [
...

  {
    ...
    overallScore: 91,
    divergence: "warning",
    divergenceNote: "Alpha confirms France win strongly (AH cascade France 0→-1.75, Score 84→50). BTTS No Score 42 below threshold (Rule 2 discard). No Under value. Haaland confirmed benched + 10 rotations — model's Norway score assumes full strength. Tier 2 nudge: reduce Norway from 1 to 0.",
    topSignals: [
      { label: "Handicap France 0", ev: "+15.4%", confidence: "high" },
      { label: "1X2 France", ev: "+23.2%", confidence: "high" },
      { label: "Handicap France -0.75", ev: "+30.1%", confidence: "high" },
      { label: "Handicap France -1", ev: "+45.0%", confidence: "medium" },
      { label: "Handicap France -1.25", ev: "+43.0%", confidence: "medium" },
    ],
    alphaPickExact: "0-2",
    alphaPickNote: "Haaland benched + 10 Norway rotations. Alpha AH cascade confirms France dominant. BTTS No Score 42 weak but lineup context reinforces. Reduced Norway from model's 1 to 0; France from 3 to 2 (Tier 2 nudge).",
  },

  {
    ...
    overallScore: 94,
    divergence: "warning",
    divergenceNote: "Iraq AH cascade: +2 Score 84, +2.75 Score 92 — market prices 2-goal Senegal margin. Senegal must-win for 3rd-place qualification race. Iraq star striker Hussein likely absent. Under 3 Score 78, Under 2.5 Score 64 signal low scoring but conflict with motivation context.",
    topSignals: [
      { label: "Handicap Iraq +2.75", ev: "+30.6%", confidence: "high" },
      { label: "Handicap Iraq +2.5", ev: "+39.3%", confidence: "high" },
      { label: "Handicap Iraq +2.25", ev: "+50.5%", confidence: "high" },
      { label: "Handicap Iraq +2", ev: "+68.8%", confidence: "high" },
      { label: "Totals Under 3", ev: "+18.0%", confidence: "high" },
    ],
    alphaPickExact: "2-0",
    alphaPickNote: "Senegal needs goals for 3rd-place race, not just a win. Iraq +2 AH Score 84 confirms 2-goal margin. Tier 2 nudge: +1 goal on Senegal from model's 1-0. Under signals present but outweighed by motivation asymmetry.",
  },

  {
    ...
    overallScore: 93,
    divergence: "warning",
    divergenceNote: "Full Cape Verde cascade: AH 0 Score 80, AH -0.25 Score 67, 1X2 CPV Score 54. BTTS No Score 78 (trusted, above 60). Under 2 Score 69. CS 0-0 EV +63.1% — highest EV signal in the entire read (Score 3, low but massive EV). Cape Verde lesson origin: picked 1-0, actual 0-0. CS 0-0 EV >40% + BTTS No >60 = Rule 9.",
    topSignals: [
      { label: "Handicap CPV +1", ev: "+11.8%", confidence: "high" },
      { label: "BTTS No", ev: "+30.9%", confidence: "high" },
      { label: "Totals Under 2.5", ev: "+24.5%", confidence: "high" },
      { label: "Handicap CPV 0", ev: "+34.7%", confidence: "high" },
      { label: "Correct Score 0-0", ev: "+63.1%", confidence: "low" },
    ],
    alphaPickExact: "1-0",
    alphaPickNote: "Pre-match pick: 1-0 Cape Verde (Tier 3 direction override). Rule 9 was not yet established — CS 0-0 EV 63.1% was the dominant signal but discounted at Score 3. Actual: 0-0. Cape Verde lesson: 0-0 Rule 9 origin.",
    signalOutcome: "miss",
    signalNote: "1-0 missed. 0-0 was the correct Rule 9 pick — BTTS No Score 78 + CS 0-0 EV 63.1% = Rule 9 trigger. Cape Verde lesson added post-match.",
  },

  {
    ...
    overallScore: 76,
    divergence: "confirmed",
    divergenceNote: "Alpha Score 76, Spain direction confirmed. CS 0-0 EV +34.1% at Score 4, CS 0-1 Spain EV +113% at Score 1. Model 1-1 — but Spain quality edge noted. Rule 10 origin: CS market with EV >80% at Score >0 flagged for future sessions.",
    topSignals: [
      { label: "1X2 Spain", ev: "+23.2%", confidence: "high" },
      { label: "Handicap Spain -0.5", ev: "+23.2%", confidence: "high" },
      { label: "Correct Score 0-1 Spain", ev: "+113.0%", confidence: "low" },
      { label: "Correct Score 0-0", ev: "+34.1%", confidence: "low" },
    ],
    alphaPickExact: "1-1",
    alphaPickNote: "Tier 1 — model anchor. Alpha confirms Spain direction but model's 1-1 was the framework pick. CS 0-1 Spain at +113% EV (Score 1) was Rule 10 origin — should have been flagged but wasn't yet established.",
    signalOutcome: "miss",
    signalNote: "1-1 missed. Actual 0-1 Spain. Rule 10 established post-match: CS EV >80% at Score >0 must be flagged in quality-gap MD3 games.",
  },

  {
    ...
    overallScore: 93,
    divergence: "warning",
    divergenceNote: "NZL AH cascade: +3 Score 92, +2.75 Score 88, +2.5 Score 85, +2.25 Score 80, +2 Score 72. Under 4 Score 85, Under 3.5 Score 74, BTTS No Score 73. Model pick 0-3 Belgium. Alpha prices Belgium winning by ~2, not 3. BTTS No Score 73 trusted. NZL scored in both prior matches (Rule 11 warning). Tier 2 nudge: Belgium -1 goal (0-3 → 0-2).",
    topSignals: [
      { label: "Handicap NZL +3", ev: "+34.7%", confidence: "high" },
      { label: "Handicap NZL +2.75", ev: "+43.9%", confidence: "high" },
      { label: "Handicap NZL +2.5", ev: "+52.5%", confidence: "high" },
      { label: "Totals Under 4", ev: "+61.0%", confidence: "high" },
      { label: "BTTS No", ev: "+25.4%", confidence: "high" },
    ],
    alphaPickExact: "0-2",
    alphaPickNote: "Tier 2 nudge from model's 0-3. AH cascade cliffs at +2.25 (Score 80) to +2 (Score 72) — market prices ~2-goal Belgium margin. BTTS No Score 73 trusted. Rule 11 caution (NZL scored every match) but Score 73 above 60 threshold.",
    signalOutcome: "miss",
    signalNote: "0-2 missed. Actual 1-5. Rule 11 reinforced: BTTS No must be above Score 80 for NZL given scoring record every game. Belgium won by 4.",
  },
...

  {
    ...
    overallScore: 87,
    divergence: "warning",
    divergenceNote: "Croatia direction confirmed (1X2 Score 74, AH -0.5 Score 74). Cascade cliffs at AH -1 Score 58, AH -2 Score 3 — margin compression signal. BTTS No Score 18 (Rule 2 discard — below 60). No Tier 2 trigger fires. Model 2-0, alpha prices Croatia by 1 more confidently than by 2. Pick compressed to 1-0.",
    topSignals: [
      { label: "Handicap CRO -0.25", ev: "+16.2%", confidence: "high" },
      { label: "1X2 Croatia", ev: "+23.2%", confidence: "high" },
      { label: "Handicap CRO -0.5", ev: "+23.2%", confidence: "high" },
      { label: "Handicap CRO -0.75", ev: "+30.1%", confidence: "high" },
      { label: "Handicap CRO -1", ev: "+45.0%", confidence: "medium" },
    ],
    alphaPickExact: "1-0",
    alphaPickNote: "Margin compressed from model's 2-0. Cascade cliff at AH -2 (Score 3) signals Croatia by 1 is the market's preferred margin. BTTS No Score 18 discarded (Rule 2). Croatia/Ghana DC Score 73 confirms narrow Croatia result. Post-match lesson: BTTS No below threshold + compressed margin = both teams score (2-1 was better).",
    signalOutcome: "miss",
    signalNote: "1-0 missed. Actual 2-1. Key calibration: compressed margin ≠ clean sheet. When BTTS No < Score 60, correct call is '1-goal win with both scoring' (2-1), not a clean sheet (1-0).",
  },

  {
    ...
    overallScore: 89,
    divergence: "warning",
    divergenceNote: "NZL+3 AH cascade Style: Panama +3 Score 92, +2.75 Score 91, +2.5 Score 88. Under 3.5 Score 77, Under 3 Score 64 — both above threshold. BTTS No Score 73 trusted. England confirmed direction (cascade England side). Model 0-3. Tier 2 trigger fires: Under Score 77 + BTTS No Score 73 + model 3 total goals = reduce by 1.",
    topSignals: [
      { label: "Handicap PAN +3", ev: "+34.7%", confidence: "high" },
      { label: "Handicap PAN +2.75", ev: "+43.9%", confidence: "high" },
      { label: "Handicap PAN +2.5", ev: "+52.5%", confidence: "high" },
      { label: "Totals Under 3.5", ev: "+30.0%", confidence: "high" },
      { label: "BTTS No", ev: "+25.0%", confidence: "high" },
    ],
    alphaPickExact: "0-2",
    alphaPickNote: "Tier 2 nudge from model's 0-3. Under 3.5 Score 77 + BTTS No Score 73 both above threshold. Panama +2.5 cascade to Score 88 suggests England by 2 is market's preferred margin. Exact hit: 0-2.",
    signalOutcome: "hit",
    signalNote: "0-2 exact hit. Under + BTTS No signals both above threshold triggered Tier 2 correctly.",
  },

  {
    ...
    overallScore: 82,
    divergence: "confirmed",
    divergenceNote: "Mutual draw structure: both Colombia (already qualified) and Portugal (advances with draw) have no incentive to overcommit. BTTS No Score 57 (below 60 threshold — Rule 2 discard). CS 0-0 EV 43.7% at low Score. Model 1-1, alpha direction confirmed. Tier 1 pick. Post-match: 0-0 actual — borderline BTTS No + CS 0-0 EV ~40% deserves more weight in mutual draw scenarios.",
    topSignals: [
      { label: "BTTS No", ev: "+20.0%", confidence: "medium" },
      { label: "Correct Score 0-0", ev: "+43.7%", confidence: "low" },
      { label: "Handicap POR 0", ev: "+15.0%", confidence: "medium" },
      { label: "1X2 Draw", ev: "+10.0%", confidence: "medium" },
    ],
    alphaPickExact: "1-1",
    alphaPickNote: "Tier 1 — mutual draw structure. Both teams safe with a draw. BTTS No Score 57 discarded (Rule 2). CS 0-0 EV 43.7% was present but at low Score and Rule 9 not triggered (BTTS No below 60). Actual: 0-0. Colombia/Portugal lesson: mutual draw + CS 0-0 EV >40% should upgrade 0-0 weight even when BTTS No is borderline.",
    signalOutcome: "partial",
    signalNote: "1-1 missed. Actual 0-0. Draw direction correct (2 pts). Rule 9 borderline case — BTTS No Score 57 just below threshold. CS 0-0 EV 43.7% + mutual draw = stronger 0-0 signal in hindsight.",
  },

  {
    ...
    overallScore: 88,
    divergence: "warning",
    divergenceNote: "Rule 9 full trigger: CS 0-0 EV 155.2% + BTTS No Score 83 (well above 60). Model pick 0-1 Uzbekistan. Rule 9 overrides: 0-0. DR Congo must-win for qualification. Uzbekistan eliminated and demoralized after 0-5 Portugal loss. Post-match: 3-1 DR Congo — motivation + attacking capability overrode even extreme alpha signals.",
    topSignals: [
      { label: "BTTS No", ev: "+45.0%", confidence: "high" },
      { label: "Correct Score 0-0", ev: "+155.2%", confidence: "low" },
      { label: "Totals Under 2", ev: "+60.0%", confidence: "high" },
      { label: "Totals Under 2.5", ev: "+40.0%", confidence: "high" },
      { label: "Handicap COD +1", ev: "+30.0%", confidence: "medium" },
    ],
    alphaPickExact: "0-0",
    alphaPickNote: "Rule 9 triggered at maximum confidence (CS 0-0 EV 155.2%, BTTS No Score 83). Cape Verde lesson applied. Actual: 3-1 DR Congo. New calibration: when must-win team has tournament attacking capability vs demoralized opponent with catastrophic recent loss, motivation overrides even extreme alpha signals.",
    signalOutcome: "miss",
    signalNote: "0-0 missed. Actual 3-1 DR Congo. Rule 9 applied correctly by framework, but DR Congo motivation + UZB demoralization (0-5 to Portugal) created exception case.",
  },

  {
    ...
    overallScore: 87,
    divergence: "warning",
    divergenceNote: "Over 1 Score 89, Over 1.5 Score 85, Over 2 Score 68. BTTS Yes Score 66 (trusted, above 60). Austria AH -0.25 Score 71, 1X2 Austria Score 56. No Low Scoring value markets — zero. Austria direction signal but no cascade. Algeria must-win (needs goals for classification). Model 0-0. Tier 3 lite: high-scoring signals dominate, BTTS Yes trusted, Algeria motivation justifies 2-goal game.",
    topSignals: [
      { label: "Totals Over 1", ev: "+19.5%", confidence: "high" },
      { label: "Totals Over 1.5", ev: "+33.3%", confidence: "high" },
      { label: "Totals Over 2", ev: "+84.1%", confidence: "high" },
      { label: "BTTS Yes", ev: "+24.3%", confidence: "high" },
      { label: "Handicap Austria -0.25", ev: "+58.5%", confidence: "high" },
    ],
    alphaPickExact: "2-1",
    alphaPickNote: "Tier 3 lite override from model's 0-0. BTTS Yes Score 66 trusted. Over 2 Score 68. Algeria must-win needs multiple goals. Austria direction signal present but no cascade — Algeria motivation and home-territory dynamic. 2-1 Algeria balances both-score signal with Algeria's qualification imperative.",
  },

  {
    ...
    overallScore: 85,
    divergence: "warning",
    divergenceNote: "Ecuador lesson + Messi confirmed benched. All 5 Argentina tournament goals attributed to Messi — model's 0-3 assumes full attack. Compression applied: 0-3 → 0-2. Jordan eliminated, likely collapses offensively (DR Congo demoralization lesson). No alpha read provided pre-match — preliminary pick based on Ecuador lesson framework.",
    topSignals: [
      { label: "1X2 Argentina", ev: "+30.0%", confidence: "high" },
      { label: "Handicap ARG -1", ev: "+40.0%", confidence: "high" },
      { label: "Handicap ARG -1.5", ev: "+35.0%", confidence: "medium" },
      { label: "Handicap JOR +2", ev: "+25.0%", confidence: "medium" },
    ],
    alphaPickExact: "0-2",
    alphaPickNote: "Ecuador lesson applied: Messi confirmed benched, Argentina rotating. All 5 tournament goals attributed to Messi — model's 0-3 overstates margin without him. Compressed to 0-2. Jordan eliminated and demoralized, clean sheet likely.",
  },
