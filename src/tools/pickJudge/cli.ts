...
import { civ_nor, fra_swe, mex_ecu, eng_cod, bel_sen, usa_bih, esp_aut, por_cro, sui_alg, aus_egy, arg_cpv, col_gha, can_mar, par_fra, mex_eng, bra_nor, sui_col, fra_mar, por_esp, usa_bel, arg_egy, esp_bel, nor_eng, arg_sui } from './__tests__/historicalFixtures';
